...
```
    ...
    |           |   |           |   |           |
    |   High    |   | High-Cost |   |  Health   |
    |Intervention   | Specific  |   |  Leaders  |
    | Priority  |   |   Risk    |   |           |
    |           |   |           |   |           |
    | 288 Dist. |   |  72 Dist. |   | 346 Dist. |
    +-----------+   +-----------+   +-----------+
          |               |               |
    +-----------+   +-----------+   +-----------+
    |  Profile  |   |  Profile  |   |  Profile  |
    |           |   |           |   |           |
    | Stunting  |   | Highest   |   | Strong    |
    | Wasting   |   | OOP Costs |   | ANC Visit |
    | Open Def. |   | Tobacco   |   | Coverage  |
    | Low ANC   |   | Use High  |   | Low       |
    | Low Vacc  |   | Remote    |   | Stunting  |
    |           |   | Terrain   |   | High Vacc |
    +-----------+   +-----------+   +-----------+
          |               |               |
    +-----------+   +-----------+   +-----------+
    ...
    |           |   |           |   |           |
    | Uttar     |   | Arunachal |   | Tamil     |
    | Pradesh   |   | Pradesh   |   | Nadu      |
    | Bihar     |   | Nagaland  |   | Kerala    |
    | Madhya    |   | Meghalaya |   | Karnataka |
    | Pradesh   |   | Manipur   |   | Andhra    |
    | Jharkhand |   | Mizoram   |   | Pradesh   |
    +-----------+   +-----------+   +-----------+
```

### Cluster 0 — High Intervention Priority (288 districts)

Districts in this cluster represent the most acute public health burden in the country. They are characterised by:
...
A geographically concentrated cluster dominated by Northeastern states, characterised by a distinct risk profile that differs from standard nutrition-deficit districts:
...
**Policy implication:** These districts need targeted financial protection schemes (PM-JAY enrollment drives), substance use programmes, and infrastructure investment in last-mile health facility connectivity.
